...
public class Board extends javax.swing.JPanel{
    ...
    private List<Direction> movementList;
            ...
            switch (e.getKeyCode()) {
                case KeyEvent.VK_LEFT:
                    if (snake.getDirection() != Direction.RIGHT) {
                        ...
                        movementList.add(Direction.LEFT);
                    }
                    break;
                case KeyEvent.VK_RIGHT:
                    if (snake.getDirection() != Direction.LEFT) {
                        snake.setDirection(Direction.RIGHT);
                        movementList.add(Direction.RIGHT);
                    }
                    break;
                case KeyEvent.VK_UP:
                    if (snake.getDirection() != Direction.DOWN) {
                        snake.setDirection(Direction.UP);
                        movementList.add(Direction.UP);
                ...
                case KeyEvent.VK_DOWN:
                    if (snake.getDirection() != Direction.UP) {
                        ...
                        movementList.add(Direction.DOWN);
    ...
    private void tick() {
        if (movementList.size() != 0) {
            Direction dir = movementList.get(0);
    ...
    private void processGameOver() {
        ...
        LosingDialog dialog = new LosingDialog(new JFrame(), true, this);
